...
if __name__ == "__main__":
    print(sys.argv[1:])
    a=['--share_policy', '--env_name', 'MPE', '--algorithm_name',
       'rmappo', '--experiment_name', 'check', '--scenario_name', 'simple_spread',
       '--num_agents', '3', '--num_landmarks', '3', '--seed', '1',
       '--n_training_threads', '1', '--n_rollout_threads', '1', '--use_render',
       '--episode_length', '25', '--render_episodes', '25','--use_wandb','False',
       '--model_dir', '/home/cc/文档/on-policy-main/onpolicy/scripts/results/MPE/simple_spread/rmappo/check/run1/models']
