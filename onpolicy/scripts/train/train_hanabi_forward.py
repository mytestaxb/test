...
if __name__ == "__main__":
    print(sys.argv[1:])
    a=['--env_name', 'Hanabi', '--algorithm_name', 'mappo', '--experiment_name',
       'mlp_critic1e-3_entropy0.015_v0belief', '--hanabi_name', 'Hanabi-Full',
       '--num_agents', '2', '--seed', '4', '--n_training_threads', '6',
       '--n_rollout_threads', '12', '--n_eval_rollout_threads', '12',
       '--num_mini_batch', '1', '--episode_length', '100',
       '--num_env_steps', '10000000000000', '--ppo_epoch', '15',
       '--gain', '0.01', '--lr', '7e-4', '--critic_lr', '1e-3',
       '--hidden_size', '512', '--layer_N', '2', '--use_eval',
       '--use_recurrent_policy', '--entropy_coef', '0.015','--use_wandb','False']
